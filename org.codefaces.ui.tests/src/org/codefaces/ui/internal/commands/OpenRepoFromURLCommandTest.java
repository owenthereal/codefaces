...
public class OpenRepoFromURLCommandTest {
	...
	private static class MockWorkSpace extends Workspace{
		private RepoFolder baseDir;
		
		@Override
		public void update(RepoFolder newBaseDirectory) {
			this.baseDir = newBaseDirectory;
		}
	...
	private static final String TEST_CORRECT_BASE_DIRECTORY = "correct/path";
	...
	private static final Object[][] NORMAL_HTTP_QUERY_PARAMETERS = {
		...
		{SCMConfigurableElement.BASE_DIRECTORY, TEST_CORRECT_BASE_DIRECTORY},
	};
	
	private static final Object[][] HTTP_QUERY_PARAMETERS_WITH_PREFIX_SLASH_URL = {
		{SCMConfigurableElement.REPO_URL, TEST_MOCK_URL},
		{SCMConfigurableElement.SCM_KIND, TEST_SCM_KIND},
		{SCMConfigurableElement.BASE_DIRECTORY, TEST_CORRECT_BASE_DIRECTORY_WITH_PREFIX_SLASH},
	};
	...
	private static final Object[][] HTTP_QUERY_PARAMETERS_WITH_TOO_LONG_URL = {
		{SCMConfigurableElement.REPO_URL, TEST_MOCK_URL},
		{SCMConfigurableElement.SCM_KIND, TEST_SCM_KIND},
		{SCMConfigurableElement.BASE_DIRECTORY, TEST_TOO_LONG_BASE_DIRECTORY},
	};
	
	private static final Object[][] HTTP_QUERY_PARAMETERS_INCORRECT_BASE_DIR = {
		{SCMConfigurableElement.REPO_URL, TEST_MOCK_URL},
		{SCMConfigurableElement.SCM_KIND, TEST_SCM_KIND},
		{SCMConfigurableElement.BASE_DIRECTORY, TEST_INCORRECT_BASE_DIRECTORY},
	};
	...
	@Test
	public void workSpaceShouldBeUpdatedWhenNormalSCMConfigurationIsPassed() throws ExecutionException{
		...
		IPath mockPath = Path.fromOSString(TEST_CORRECT_BASE_DIRECTORY);
		...
		RepoFolder baseDir = workspace.getBaseDirectory();
		assertNotNull(baseDir);
		assertEquals(TEST_SCM_KIND, baseDir.getRoot().getRepo().getKind());
		assertEquals(TEST_USER, baseDir.getRoot().getRepo().getCredential().getUser());
		assertEquals(TEST_PASSWORD, baseDir.getRoot().getRepo().getCredential().getPassword());
		assertEquals(mockPath.lastSegment(), baseDir.getName());
	}
	
	@Test
	public void workSpaceShouldBeUpdatedIfUrlContainsPrefixSlash() throws ExecutionException{
	...
	@Test
	public void repoRootShouldBeReturnedIfRootPathIsPassed() throws ExecutionException{
		...
		handler.execute(event);
		RepoFolder baseDir = workspace.getBaseDirectory();
		assertTrue(baseDir instanceof RepoFolderRoot);		
	}
	
	@Test
	public void repoRootShouldBeReturnedIfNoPathIsPassed() throws ExecutionException{
	...
	public void throwExceptionIfThePathHasDepthLargerThan2() throws ExecutionException{

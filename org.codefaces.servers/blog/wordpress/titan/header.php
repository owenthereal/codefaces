...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="http://codefaces.com/wp-content/uploads/2010/06/favicon2.gif" />
		...
		<div id="follow">
			<div class="wrapper clear">
				<dl>
					...
					<dd><a class="rss" target="_blank" href="<?php bloginfo( 'rss2_url'); ?>"><?php _e( 'RSS', 'titan' ); ?></a></dd>
					...
					<?php if ($titan->twitterToggle() == 'true' ): else : ?>
					 <dd><a class="twitter" target="_blank" href="<?php if ($titan->twitter() !== '' )echo $titan->twitter(); else echo "#"; ?>"><?php _e( 'Twitter', 'titan' ); ?></a></dd>
					<?php endif; ?>
				</dl>
			</div><!--end wrapper-->
		</div><!--end follow-->

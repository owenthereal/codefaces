...
<div id="v-options">
	<div class="v-top clear">
		<h1 class="v-trial"><?php echo $this->themename; ?> <?php _e( 'Options', 'titan' ); ?></h1>
		<div class="v-logo"><a href="http://thethemefoundry.com/">The Theme Foundry</a></div>
	</div>
	<div id="vop-header"><p><strong><?php _e( 'Need help?', 'titan' ); ?></strong> <a href="http://thethemefoundry.com/tutorials/titan/"><?php _e( 'Read the tutorials' , 'titan'); ?></a> <?php _e( 'or visit the <a href="http://thethemefoundry.com/forums/">support forums.</a>', 'titan'); ?></p></div>
	<div class="v-notice">
		<h3><?php _e( 'Go PRO!', 'titan' ); ?></h3>
		<p><?php _e( 'You are using the free version of Titan. Upgrade to Titan PRO for extra features, access to dedicated support, priority theme updates, and comprehensive theme tutorials.', 'titan'); ?></p>
		<p><a href="http://thethemefoundry.com/titan/"><?php _e( 'Learn more about Titan PRO &rarr;', 'titan' ); ?></a></p>
	</div>
	<div id="vop-body">
		<form method="post">
<?php
